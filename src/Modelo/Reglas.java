...
public class Reglas {
    ...
    protected boolean tieneTrio(int[] conteo){ //chequeo si tiene trio de alguno de los numeros
        for(int i=1; i <= 6; i++ ){
            if(conteo[i]>=3){
                return true;
            }
    ...
    protected boolean tieneEscalera(int[] conteo){ //chequeo si tiene escalera
    ...
    public void actualizar_dados_apartados(ArrayList<Dado> new_dados_apartados){
        dadosApartados = new_dados_apartados;
    }
}
